...
?>
        <section class="banner" id="banner">
            <div class="bannertext"id="bannertext">
                ...
                <p class="motto"><span style="color:white">Motto:<span><span style="color:yellow"> Knowledge, Skill and Character</span></p>
        ...
        <div class="wrapper">
            ...
            <section class="about_us" id="about_us">
                ...
                <button onclick="location.href='about_us.php'">LEARN MORE <span>&#10095;</span></button>
            </section>
            <section id="why_us" class="why_us">
                ...
                <button onclick="location.href='our_mission.php'">KNOW MORE <span>&#10095;</span></button>
            </section>
